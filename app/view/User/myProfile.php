<div class="p-0 m-0 cover back-image">
    <img src="<?= $backImage ?>" class="img-fluid w-100 h-100" id="myImg" alt="Responsive image">
    <a href='<?= "/user/saveBackImage?id={$id}&&src="?>' class="btn btn-danger uploadFile" id="save">Save</a>
</div>
<div class="container">
    <div class="row m-0 p-0">
        <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 p-3">
            <div class="card-user-other bg-light m-0  shadow-sm p-3 mb-5 bg-white rounded">
                ...
                <div class="row mt-0 p-0">
                    <div class="col-md-12 col-lg-6 col-sm-12 col-xs-12 mt-2">
                        <div class="text-center pt-2">
                            <h3>Friends</h3>
                            <h4><?= (isset($friends)) ? count($friends) : 0 ?></h4>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6 col-sm-12 col-xs-12 mt-2">
                        <div class="text-center pt-2">
        ...
        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 mt-5 p-3">
            <div class="d-none d-sm-block d-sm-none d-md-block shadow-sm p-3 mb-5 bg-white rounded">
                <h3><?= $name ?></h3>
            ...
            <div class="tebs">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        <div class="mt-4 p-3 border bg-light">
                            <form action="<?= "/user/uploadFile?id={$id}&&dir={$user_dir}" ?>" class=" d-none d-sm-none d-md-block" method="POST" enctype="multipart/form-data">
                                <div class="input-group" id="imageURL">
                                ...
                                <input type="submit" class="btn btn-primary w-100" id="upload" value="submit" name="submit">
                            </form>
                            <div class="row p-3">
        ...
        <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 mt-5 p-3 ">
            <div class="mt-4 p-3 border bg-light d-none d-sm-none d-md-block shadow-sm p-3 mb-5 bg-white rounded">
                <div>
